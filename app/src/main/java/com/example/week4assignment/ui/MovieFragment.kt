...
import com.example.week4assignment.databinding.FragmentMovieBinding
...
class MovieFragment : Fragment() {
                ...
                is UIState.ERROR -> {
                    ...
                    AlertDialog.Builder(requireActivity())
                        ...
                        .setPositiveButton("Retry") { dialog, _ ->
                            mMovieViewModel.getMovieData(page)
                            dialog.dismiss()
                        }
                        .create()
                        .show()
    ...
    override fun onStart() {
        super.onStart()
        Log.d(TAG,"Page Number is : " + page.toString())
        ...
        recyclerView.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
                ...
                if (!recyclerView.canScrollVertically(1) && newState == RecyclerView.SCROLL_STATE_IDLE) {
                    page++
                    mMovieViewModel.getMovieData(page)
                    Log.d(TAG, "test 1:" + recyclerView.layoutManager?.itemCount.toString())
                    Log.d(TAG, "test 2:" + page.toString())
                }
            }
        })
    }
    ...
    override fun onViewStateRestored(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            itemCount = newCount
            Log.d(TAG, "test 3:" + itemCount.toString())
            page = pageCount
            Log.d(TAG, "test 4:" + page.toString())
        } catch (e: Exception) {
